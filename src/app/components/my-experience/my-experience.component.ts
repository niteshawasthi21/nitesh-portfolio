  ...
  workExperiences: any = [
    {
      company: "NeoSol",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQshgd592Ln6ffThAIk8opltf1PsMqlhKFUaw&s", // Replace with actual logo URL
      position: "Senior Software Engineer",
      duration: "Dec 2025 - Present",
      description: [
        "Leading frontend development and contributing to backend services for a scalable EdTech LMS platform handlinghigh user concurrency and complex data interactions.",
        "Architecting reusable, modular React components and integrating REST APIs to deliver user-centric features.",
        "Collaborating with product and backend teams in Agile sprints to deliver high-quality features on time",
        "Mentoring junior developers and conducting code reviews to maintain code quality and consistency.",
        "Implementing performance optimizations and best practices to ensure a smooth user experience.",
      ],
    },
    {
      company: "QX Global Group Ltd",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_oYvAG49WIO9dzgJ01xeh7CbiDq3yQXllVg&s", // Replace with actual logo URL
